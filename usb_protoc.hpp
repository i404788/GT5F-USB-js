...
void configure_io(struct sg_io_hdr *hdr, uint8_t *packet, size_t packet_len, bool bRead)
{
...
int32_t runCommand(int32_t fd, uint16_t cmd, uint32_t param, CmdPacket &result)
{
  CmdPacket cmdpacket = {CmdHeader, 0x1, {param, cmd}};
